...
import bestSelling from '../../data/categoryList/bestSelling'

const BestSelling = ({selectedTab}) => {
  return (
    <View style={styles.wrapper}>
        <View style={styles.titleCon}>
          <Text style={{fontSize: 20, fontWeight: 400, marginBottom: 22}}>BestSelling</Text>
        </View>
            ...
            >
                ...
                <View key={item.id}>
                   <View style={styles.bookCon}>
                       <Image style={{height: 165, width: 124, marginLeft: -15, position: 'relative'}} source={item.img} />
